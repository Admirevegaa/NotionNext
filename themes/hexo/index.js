  ...
  return (
    <ThemeGlobalHexo.Provider value={{ searchModal }}>
      <div
        ...
        <main
          id='wrapper'
          className={`${siteConfig('HEXO_HOME_BANNER_ENABLE', null, CONFIG) ? '' : 'pt-16'} bg-[url('https://i.postimg.cc/xY5bZWXh/123793496-p0.png')] w-full py-8 md:px-8 lg:px-24 min-h-screen relative`}>
          <div
            id='container-inner'
            className={
