export default function ANIAdmire(){
  let count = 0;
      ...
      countDisplay.innerHTML = count;//点击计数器
      ...
      img.addEventListener("click", function() {
        if( count == 3){ //每点击四次更换一次素材
            ...
            if (flag){
                ...
                img.style.animation = "jump 0.7s linear 0s 1,gululu 0.7s linear 0s 1";//动画赋值
                img.src = "https://patchwiki.biligame.com/images/umamusume/0/08/7u6ud327zarqitc9i49ftudknxzw674.png";
                flag = true;//更换素材
                img.addEventListener("webkitAnimationEnd", myEndFunction);//动画播放完成后清空动画
