...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一等星の輝きを……ここに。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://admirevega.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AdmireVega', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/admire.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    'あの子に捧げる星を…この脚で、勝ち取ってみせる！, 一等星の輝きを……ここに。',
